...
public class QuestionManagement extends JFrame {
    ...
    private void initComponents() {
        // Bắt
        textFieldQuestionID.setBorder(new QuestionManagement.BottomBorder(Color.BLACK, 1));
        textFieldExamID.setBorder(new QuestionManagement.BottomBorder(Color.BLACK, 1));
        textFieldContent.setBorder(new QuestionManagement.BottomBorder(Color.BLACK, 1));
        textFieldSearch.setBorder(new QuestionManagement.BottomBorder(Color.BLACK, 1));

        addButton.setBorder(new QuestionManagement.BottomBorderNut(Color.BLACK));
        updatedButton.setBorder(new QuestionManagement.BottomBorderNut(Color.BLACK));
        deleteButton.setBorder(new QuestionManagement.BottomBorderNut(Color.BLACK));
        refreshButton.setBorder(new QuestionManagement.BottomBorderNut(Color.BLACK));
        answerManagementButton.setBorder(new QuestionManagement.BottomBorderNut(Color.BLACK));
        backButton.setBorder(new QuestionManagement.BottomBorderNut(Color.BLACK));
        // kết
        ...
        tableViewQuestion.getTableHeader().setFont(headerFont);

        // Đặt màu sắc cho tiêu đề cột
        tableViewQuestion.getTableHeader().setForeground(Color.BLACK);
        // Kết
