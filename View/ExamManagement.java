...
public class ExamManagement extends JFrame {
    ...
    private void initComponents() {
        ...
        tableViewExam.getTableHeader().setFont(headerFont);

        // Đặt màu sắc cho tiêu đề cột
        tableViewExam.getTableHeader().setForeground(Color.BLACK);
        // Kết
    ...
    private void createUIComponents() {
        ...
        textFieldExamID.setBorder(new ExamManagement.BottomBorder(Color.BLACK, 1));
        textFieldSubject.setBorder(new ExamManagement.BottomBorder(Color.BLACK, 1));
        textFieldTotalQuestion.setBorder(new ExamManagement.BottomBorder(Color.BLACK, 1));
        textFieldTotalScore.setBorder(new ExamManagement.BottomBorder(Color.BLACK, 1));
        textFieldFind.setBorder(new ExamManagement.BottomBorder(Color.BLACK, 1));

        addButton.setBorder(new ExamManagement.BottomBorderNut(Color.BLACK));
        updatedButton.setBorder(new ExamManagement.BottomBorderNut(Color.BLACK));
        deleteButton.setBorder(new ExamManagement.BottomBorderNut(Color.BLACK));
        refreshButton.setBorder(new ExamManagement.BottomBorderNut(Color.BLACK));
        backButton.setBorder(new ExamManagement.BottomBorderNut(Color.BLACK));
    }
    // Kết
}
