...
public class AnswerManagement extends JFrame {
    ...
    private void initComponents() {
        ...
        // Bắt
        textFieldQuestionID.setBorder(new BottomBorder(Color.BLACK, 1));
        textFieldAnswerID.setBorder(new BottomBorder(Color.BLACK, 1));
        textFieldAnswer.setBorder(new BottomBorder(Color.BLACK, 1));
        textFieldSearch.setBorder(new BottomBorder(Color.BLACK, 1));

        addButton.setBorder(new BottomBorderNut(Color.BLACK));
        updatedButton.setBorder(new BottomBorderNut(Color.BLACK));
        deleteButton.setBorder(new BottomBorderNut(Color.BLACK));
        refreshButton.setBorder(new BottomBorderNut(Color.BLACK));
        backButton.setBorder(new BottomBorderNut(Color.BLACK));
        // kết
