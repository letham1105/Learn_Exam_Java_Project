...
public class UserManagement extends JFrame{
    ...
    private void createUIComponents() {
        // Bắt
        textfieldUserID.setBorder(new UserManagement.BottomBorder(Color.BLACK, 1));
        textfieldFullName.setBorder(new UserManagement.BottomBorder(Color.BLACK, 1));
        textfieldPassword.setBorder(new UserManagement.BottomBorder(Color.BLACK, 1));
        textfieldFind.setBorder(new UserManagement.BottomBorder(Color.BLACK, 1));

        addButton.setBorder(new UserManagement.BottomBorderNut(Color.BLACK));
        updatedButton.setBorder(new UserManagement.BottomBorderNut(Color.BLACK));
        deleteButton.setBorder(new UserManagement.BottomBorderNut(Color.BLACK));
        refreshButton.setBorder(new UserManagement.BottomBorderNut(Color.BLACK));
        backButton.setBorder(new UserManagement.BottomBorderNut(Color.BLACK));
        // kết
    }
