...
public class ExaminationRoomManagement extends JFrame{
    ...
    private void createUIComponents() {
        ...
        textFieldRoomID.setBorder(new ExaminationRoomManagement.BottomBorder(Color.BLACK, 1));
        textFieldExamID.setBorder(new ExaminationRoomManagement.BottomBorder(Color.BLACK, 1));
        textFieldTitle.setBorder(new ExaminationRoomManagement.BottomBorder(Color.BLACK, 1));
        textFieldTimeLimit.setBorder(new ExaminationRoomManagement.BottomBorder(Color.BLACK, 1));
        textFieldRoomPassword.setBorder(new ExaminationRoomManagement.BottomBorder(Color.BLACK, 1));
        textFieldSearch.setBorder(new ExaminationRoomManagement.BottomBorder(Color.BLACK, 1));

        addButton.setBorder(new ExaminationRoomManagement.BottomBorderNut(Color.BLACK));
        updatedButton.setBorder(new ExaminationRoomManagement.BottomBorderNut(Color.BLACK));
        deleteButton.setBorder(new ExaminationRoomManagement.BottomBorderNut(Color.BLACK));
        finalGradeButton.setBorder(new ExaminationRoomManagement.BottomBorderNut(Color.BLACK));
        refreshButton.setBorder(new ExaminationRoomManagement.BottomBorderNut(Color.BLACK));
        backButton.setBorder(new ExaminationRoomManagement.BottomBorderNut(Color.BLACK));
    }


    // Thêm
    public class BottomBorder extends MatteBorder {
        public BottomBorder(Color color, int thickness) {
            super(0, 0, thickness, 0, color);
        }
    }
    ...
    private void initComponents() {
        ...
        // Thêm
        // Đặt font chữ cho tiêu đề cột
        Font headerFont = new Font("Cosolas", Font.BOLD, 14);
        tableviewRoom.getTableHeader().setFont(headerFont);

        // Đặt màu sắc cho tiêu đề cột
        tableviewRoom.getTableHeader().setForeground(Color.BLACK);
        // Kết
